import {FontSVNPoppins} from 'assets';
...
import {COLORS, DEFAULT_STYLES, Size, fs, handleFlex, handleRound, handleSquare, hs} from 'theme';
...
export type TextInputProps = RNTextInputProps &
  Partial<{
    ...
    color: ColorValue;
    fontSize: number;
    font: keyof typeof FontSVNPoppins;
...
export const TextInput = forwardRef(
  (
    ...
    const _style = [
      {
        ...
        fontFamily: FontSVNPoppins[font],
      },
    ...
    return <RNTextInput maxLength={100} ref={ref} selectionColor={COLORS.primary} {...props} style={_style} />;
  },
);
