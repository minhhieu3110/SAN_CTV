...
export const LOCAL_URL = 'https://san.thietkewebsite.info.vn/api/';

export const URL_UPLOAD = 'https://san.thietkewebsite.info.vn/' + 'uploads/';

const instance = axios.create({baseURL: LOCAL_URL, timeout: 30000});
